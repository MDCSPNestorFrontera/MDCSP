...
export const siteContent = {
  es: {
    ...
    clinic: {
      ...
      phone: '(787) 821-4417',
      phones: ['(787) 821-4417', '(787) 821-5828', '(787) 821-4829'],
      ...
      planNote: 'Aceptamos la mayoría de los planes médicos. Llama para más información.',
      hours: [
  ...
  en: {
    ...
    clinic: {
      ...
      planNote: 'We take most medical plans. Call for more information.',
      hours: [
